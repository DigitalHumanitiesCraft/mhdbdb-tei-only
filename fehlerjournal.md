...
**Zum Suchen dieser Lehre, damit die nächste Session den Zuschnitt nicht wiederholt.** Eine Suche nach `korrigieren.md` in diesem Journal ergibt null, und das ist kein Nullbefund: die Lehre steht hier zweimal, aber beide Male in Prosa („Nachbarschaft", „mitwächst"). **Eine Regeldatei beim Namen nennen überhaupt nur die Einträge 12, 30, 34, 36, 37, 38, 39 und die von heute**, und von den Einträgen 1 bis 35 sind es genau drei: 12, 30 und 34. Der praktische Satz daraus, und er gilt unabhängig von jeder Zahl: **wer ein Fehlerjournal nach Regeldateinamen durchsucht, sieht die ersten 35 Einträge nicht.** Die Gewohnheit ist ein paar Tage alt.
...
**Die Lehre, die nicht gegriffen hat, steht in `dateisuche.md`, und zwar in ihrem Zuschnitts-Halbsatz: den Zuschnitt prüft der Kontrollwert nur mit, wenn er außerhalb von ihm liegt.** Mein Kontrollwert war stark und lag mitten im Zuschnitt: 613 Typen mit mehr als einer Form und 1 mit mehr als einem Lemma, vor und nach dem Lauf identisch. Er misst die **Typ**-Ebene, und auf der war auch alles richtig. Die Frage, die `dateisuche.md` davorsetzt, habe ich nicht gestellt: warum ist der Suchpfad dieser und nicht der ganze Bestand. Die letzte Zeile zu dieser Lehre ist Eintrag 26.
