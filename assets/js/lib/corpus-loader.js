...
const INDEX_VERSION = '4.1.7';  // 4.1.5: #143 APO/HMT/HH Prosa-Konversion l→lb. 4.1.6: #198 habe/hab-Disambiguierung (25 Tokens zu lemma_2593, 179 NOM-Strips). 4.1.7: #189 GWTK-Pilot — 257 nackte rot/jung-Tokens neu annotiert (Goldstandard-validiert).
const AUTHORITY_INDEX_VERSION = '1.6.2';  // 1.2.0: Authority migration. 1.2.1: WZB-Lemmata + Werk-Eintrag. 1.2.2: #104 FLG/FLG1-Werk-Titel + work_571 biblStruct (Vollmann-Profe/Neumann 1990). 1.3.0: #113-Followup — concepts altDE/altEN/altNormalized. 1.4.0: #44/#115 variants.xml aus Korpus regeneriert (+64.287 Formen). 1.4.1: #125 deterministischer Build (generatedAt entfernt). 1.4.2: #143 HH-Genre-Korrektur (work_137). 1.4.3: #143 APO-Gattung nach Terrahe (work_568). 1.4.4: #115 A-Stub-Backfill (+125 Lemmata). 1.5.0: Audit #5 — parse_genres last-wins-Fix (250 Genre-Labels) + genre altDE/altEN/altNormalized. 1.6.0: #161 posAll[] Multi-POS (pos bleibt Erstwert). 1.6.1: #189 GWTK-Pilot — variants.xml +2 Typen (rotte/rotten unter lemma_4954) + Formen-Zuwachs aus der Neu-Annotation. 1.6.2: #224 NFC-Unicode-Komposition im Normalizer — zerlegte Umlaute (o + U+0308) werden jetzt komponiert, bevor die Umlaut-Regeln greifen; korrigiert 'hugo von mühldorf' zu 'hugo von muehldorf' in persons.xml (die Quelldatei traegt dort ein zerlegtes ue).
