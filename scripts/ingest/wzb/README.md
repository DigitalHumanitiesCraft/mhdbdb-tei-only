...
Siehe [docs/DATA-MODEL.md → Ingest-Verfahren](../../../docs/DATA-MODEL.md#ingest-verfahren-neuaufnahme-von-texten) für das normative Phasenmuster. Die historische WZB-Detail-Doku (inkl. pre-registriertem Phase-3-Evaluationsprotokoll) liegt in der Git-History unter `docs/features/034-wenzelsbibel-annotation.md` (#34, gelöscht per Temporal-Artifacts-Konvention).
