...
def build_corpus_index(jobs=1):
    ...
    # Build final index
    index = {
        'version': '4.2.3',  # 4.1.5: #143 APO/HMT/HH Prosa-Konversion l→lb (lineStarts/lineEnds entfallen für die drei Texte). 4.1.6: #198 habe/hab-Disambiguierung (25 Tokens zu lemma_2593, 179 NOM-Strips). 4.1.7: #189 GWTK-Pilot — 257 nackte rot/jung-Tokens neu annotiert (rôt/rote/junc, Goldstandard-validiert). 4.1.8: #138 814 Strophenziffern aus dem HUG-Verstext entfernt (706 davon pos=DIG, 108 unannotiert; die Strophenzahl steht ab jetzt nur noch in lg/@n). 4.2.0: #236 Frauenlob-Revision — FR3 Parallelueberlieferungs-Ebene rekonstruiert (23 gleichrangige Toene zu 10 zusammengefuehrt, 36 <div type="parallel">, 1.563 Verse jetzt als Parallelueberlieferung erkennbar); 42 roemische Ordnungszahl-Tokens aus FR1/FR2/FR3 entfernt und durch <head> ersetzt. 4.2.1: #228 sieben leere <author>-Elemente im titleStmt gefuellt (ALX/BVSN/PSG/PTS Moench von Heilsbronn, BOP Boppe, MHG Herger, MRB Burggraf von Riedenburg); betrifft nur das Feld text.author, keine Token- oder Positionsdaten. Ausserdem normalisiert der Build Whitespace im Autornamen: LUU trug ihn ueber zwei eingerueckte Zeilen, der Umbruch stand so in Index und API. 4.2.2: #235 28 der 34 WZB-Tokens aus dem Split von f3dcf2a8 lemmatisiert. Der Split hatte 17 <w> mit literalem Backslash-u0020 in je zwei Tokens zerlegt, die alle kein @lemmaRef trugen. Zugewiesen nach WZB-interner Belegverteilung derselben Wortform, nicht ueber den Varianten-Matcher: variants.xml ist seit der Ingest-Phase nicht regeneriert und kennt die in Phase 1b angelegten Lemmata nicht (lateinisches 'et' steht 16x auf lemma_78608, der Matcher bot dafuer drei falsche Kandidaten an). Bei 24 Tokens war auch @pos korpusintern einstimmig und wurde mitgesetzt. Sechs bleiben offen und brauchen eine Handentscheidung: 3x 'in' (drei Lemmata im Bestand), 'Gen', i-mit-Makron und 'salacha'. 4.2.3: #198 Schritt 2. Die drei aus PR #205 zurueckgehaltenen NOM-Tokens sind entschieden (AC3_23010_1 'hawe vnd schaufel' auf lemma_9644 houwe, DA_8222_3 'dehein habe' auf lemma_2593 habe, JT_6192000_1 verbal, NOM aus dem Compound gestrichen); damit traegt kein <w> unter lemma_2598 mehr ein NOM. Ausserdem ist das in PR #205 entfernte @ana der umgehaengten Tokens gesetzt: 24 WZB-Belege plus DA_8222_3 auf lemma_2593_sense_4159 (Besitz), AC3_23010_1 auf den einzigen Sense von lemma_9644. Drei Tokens bleiben bewusst ohne @ana (TKA_950041520_4 meint eine Handlungsweise, die kein Sense abdeckt; FB_627018_3 und TRO_10715_5 stammen aus dem Altbestand). variants.xml aendert sich dadurch nicht.
