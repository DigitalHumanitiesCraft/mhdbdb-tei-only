...
Index structure (v4.1.1 - DOCUMENT-LEVEL + LINE BOUNDARIES):
{
  "version": "4.1.1",
...
def build_corpus_index():
    ...
    # Build final index
    index = {
        'version': '4.1.1',  # 4.0.0: document-level indexing. 4.0.1: WZB. 4.1.0: lineStarts/lineEnds für #47.3. 4.1.1: #23 Stanza-Wraps.
