...
2. Adds comments for non-standard dates
3. Creates a log file with all non-standard dates found
"""
...
def clean_tei_file(filepath, date_log):
    ...
    try:
        ...
        # 2. Add comments for non-standard dates and log them
        for elem in root.iter():
...
if __name__ == "__main__":
    main()
# This script is designed to be run in a directory containing TEI XML files.
# It will process each file, clean it up, and generate a log of non-standard dates