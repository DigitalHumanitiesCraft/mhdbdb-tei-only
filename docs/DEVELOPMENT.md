...
15. **Two-stage RelaxNG validation** (P2-13) – stage 1 `tei_all.rng` (warnings, the #30 baseline), stage 2 `mhdbdb.rng`/`mhdbdb-authority.rng` (hard gate). Deliberately last, as the most expensive check.
