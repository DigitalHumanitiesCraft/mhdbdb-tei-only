...
│   ├── genre-explorer.js
│   └── name-explorer.js
├── tei/               # TEI text analysis (Release 1 + 2 + #47.3)
│   ├── tei-ui.js
...
│   └── concept-distribution.js    # Begriffs-Verteilung (#47 R2)
└── search/
    └── SearchHelpers.js
```
...
| Begriffs-Verteilung | `#concept-distribution` | Bar-Chart pro Konzept über alle Texte (#47 R2) |
