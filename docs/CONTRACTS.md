...
- 234,250 normalized entries (as of 2026-09-21; 256,783 raw forms in variants.xml, deduped first-occurrence-wins), extracted from `authority-files/variants.xml`
