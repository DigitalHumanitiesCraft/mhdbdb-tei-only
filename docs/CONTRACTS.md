...
- 234,245 normalized entries (as of 2026-09-15; 256,773 raw forms in variants.xml, deduped first-occurrence-wins), extracted from `authority-files/variants.xml`
