...
| #172 | Test-Suite-Policy (Audit 6/6) | Der 45%-passRate-Floor ist mit #326 entfallen: er lebte in `testing/test.html`, und die Seite ist gelöscht. Offen bleiben die korpusabhängigen Magic-Numbers |
