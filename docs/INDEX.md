...
- **TEI Analysis** - Eleven analysis tools over the pre-loaded MHDBDB corpus: multi-lemma search (document + proximity), verse-position lemma search, word frequency, corpus-wide hapax legomena, text statistics, lemma distribution, concept distribution, text comparison, co-occurrence ranking, rhyme dictionary, curated character-naming explorer (4 works, Beta)
...
Aktuelle Index-Versionen siehe [TEI-MODEL.md §11](TEI-MODEL.md#11-versionierung) (Stand 2026-07-07: Corpus Index v4.1.5, Authority Index v1.6.0).
