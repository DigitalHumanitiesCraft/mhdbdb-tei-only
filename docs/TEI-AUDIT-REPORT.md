...
|--------|------|
| Dateien | 666 |
| Elemente gesamt | 12,764,576 |
| Groesste Datei | OVG.tei.xml (629,091 Elemente) |
| Kleinste Datei | EUS.tei.xml (156 Elemente) |
| Distinkte Elemente | 77 |
...
| 8 | `<supplied>` | 23,402 | 315 | l, p, hi, note, head | @n |
| 9 | `<p>` | 10,190 | 666 | div, projectDesc, editorialDecl, lg, availability | @xml:lang, @n |
| 10 | `<gloss>` | 8,698 | 666 | category | @xml:lang |
| 11 | `<pb>` | 6,197 | 46 | p, l, head, div, note | @n, @type |
...
**Eltern:** `<l>` (8,224,841), `<p>` (619,298), `<hi>` (379,939), `<supplied>` (53,894), `<head>` (3,783), `<div>` (1,044), `<body>` (103), `<note>` (60), `<lg>` (18), `<num>` (2)
...
**Eltern:** `<l>` (1,304,030), `<p>` (64,150), `<head>` (1,054), `<supplied>` (764), `<div>` (88), `<note>` (82), `<body>` (15), `<hi>` (5), `<lg>` (3)
...
**Eltern:** `<l>` (358,376), `<hi>` (36,932), `<p>` (12,472), `<supplied>` (5,926), `<head>` (1,345), `<note>` (226), `<body>` (10), `<div>` (8)
...
**Kinder:** `<l>` (6,709), `<p>` (5,413), `<head>` (3,090), `<div>` (1,964), `<w>` (1,044), `<lb>` (92), `<seg>` (88), `<lg>` (68), `<pb>` (28), `<hi>` (8)
...
**Kinder:** `<w>` (8,224,841), `<seg>` (1,304,030), `<hi>` (358,376), `<caesura>` (52,950), `<supplied>` (21,447), `<pb>` (292), `<note>` (245), `<num>` (1)
...
**Kinder:** `<l>` (187,216), `<p>` (1,122), `<note>` (132), `<head>` (37), `<w>` (18), `<seg>` (3)
...
**Eltern:** `<div>` (5,413), `<projectDesc>` (1,332), `<editorialDecl>` (1,332), `<lg>` (1,122), `<availability>` (666), `<body>` (325)
...
**Eltern:** `<l>` (21,447), `<p>` (1,379), `<hi>` (295), `<note>` (137), `<head>` (123), `<supplied>` (20), `<div>` (1)

**Kinder:** `<w>` (53,894), `<hi>` (5,926), `<seg>` (764), `<l>` (679), `<supplied>` (20), `<lb>` (6), `<note>` (1), `<caesura>` (1)
